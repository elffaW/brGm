...
public class beerSearch extends baseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setup receiver variables on beer submit
        ...
        public void onResponse(Call call, Response response) throws IOException {
            ...
            runOnUiThread(new Runnable() {
                    ...
                    for (int i = 0; i < N; i++){
                        ...
                        styleNameTextView.setTypeface(EasyFonts.ostrichLight(getApplicationContext()));
